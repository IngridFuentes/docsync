...
const FileItem: React.FC<{ file: FileNode; onSelect: (f: FileNode) => void; isSelected: boolean }> = ({ file, onSelect, isSelected }) => {
  ...
  return (
    <div 
      ...
      className={`
        flex items-center gap-2 px-3 py-2 cursor-pointer text-sm font-mono border-l-2 transition-colors
        ${isSelected 
  ...
  return (
    <div className="w-64 flex-shrink-0 border-r border-zinc-800 bg-zinc-900/50 flex flex-col h-full">
      <div className="p-4 border-b border-zinc-800">
        <h3 className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Explorer</h3>
      </div>
